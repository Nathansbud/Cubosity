...
void GLWidget::mouseReleaseEvent(QMouseEvent *event)
{
    ...
    // Try to precompute; whether we actually need to do anything depends on if we've moved
    this->m_arap.precompute();
}
...
void GLWidget::keyPressEvent(QKeyEvent *event)
{
    ...
    case Qt::Key_Shift: m_vertical -= SPEED; break;
    case Qt::Key_Space: m_vertical += SPEED; break;
    case Qt::Key_C: m_camera.toggleIsOrbiting(); break;
    case Qt::Key_R: m_arap.resetAnchors(); break;
...
void GLWidget::cubify() { m_arap.cubify(settings); }
